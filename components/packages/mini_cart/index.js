...
class MiniCart extends React.Component {
  ...
  render() {
    const { cartState, removeFromCart } = this.props;
    ...
    return (
      <div className="acf-mini-cart">
        <div className="acf-mini-cart__inner" onClick={this.toggleDropdown}>
          ...
          <div className="acf-mini-cart__count">{count}</div>
        </div>
        {count > 0 && showDropdown && (
          <div className="acf-mini-cart-dropdown">
            ...
            <div className="acf-mini-cart-dropdown-total">
              <span className="acf-mini-cart-dropdown-total__label">
                Sub-total:
              </span>
              <span className="acf-mini-cart-dropdown-total__value">
                ${totalPrice.toFixed(2)}
              </span>
            </div>
            <div className="acf-mini-cart-dropdown__actions">
              <a className="acf-mini-cart-dropdown-button" href={ACF_PATH_CART}>
                View Bag
              </a>
              <a
                className="acf-mini-cart-dropdown-button acf-mini-cart-dropdown-button__primary"
                href={ACF_PATH_CHECKOUT}>
                Checkout
              </a>
            </div>
          </div>
...
const MiniCartWithStore = connect(
  mapStateToProps,
  mapDispatchToProps
)(MiniCart);
